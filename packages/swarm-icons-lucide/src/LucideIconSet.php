...
namespace Frostybee\SwarmIcons\Lucide;
...
/**
 * Registers Lucide Icons (~1,500 SVGs) with the SwarmIcons manager.
 *
 * Usage:
 * ```php
 * LucideIconSet::register($manager);
 * echo icon('lucide:home');
 * ```
 *
 * SVGs are located in resources/svg/. Populate with:
 * ```
 * php bin/build-icon-sets.php lucide
 * ```
 */
class LucideIconSet implements IconSetInterface
{
