...
**Per-prefix fallback**: use a different placeholder for specific icon sets:

```php
->fallbackIconForPrefix('tabler', 'tabler:help')
->fallbackIconForPrefix('mdi', 'mdi:help-circle-outline')
```
