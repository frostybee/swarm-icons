...
```bash
php vendor/bin/swarm-icons cache:clear
php vendor/bin/swarm-icons cache:clear --path=/var/cache/icons
```
...
```bash
php vendor/bin/swarm-icons cache:warm --prefix=tabler --icons=home,user,settings,arrow-left
```
...
php vendor/bin/swarm-icons icon:list --path=/path/to/svgs

# From an Iconify set (fetches from API)
php vendor/bin/swarm-icons icon:list --prefix=tabler --iconify

# Filter by name
php vendor/bin/swarm-icons icon:list --prefix=heroicons --iconify --search=chevron
```
...
```bash
php vendor/bin/swarm-icons init
php vendor/bin/swarm-icons init --output=config/swarm-icons.php
php vendor/bin/swarm-icons init --force   # overwrite an existing file
```
